...
function reactNativeImageHashPlugin(assetData) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filePath = assetData.files.length ? assetData.files[0] : "";
...
function shouldConvertFile(assetData, filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var allTypes, ignoreRegex;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, asyncLoadConfig];
                case 1:
                    allTypes = (_a.sent()).types;
                    return [4 /*yield*/, asyncLoadConfig];
                case 2:
                    ignoreRegex = (_a.sent()).ignoreRegex;
